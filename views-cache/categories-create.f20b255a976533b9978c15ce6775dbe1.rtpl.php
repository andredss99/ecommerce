...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/index.php/admin/categories">Categorias</a></li>
    <li class="active"><a href="/index.php/admin/categories/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/index.php/admin/categories/create" method="post">
          <div class="box-body">
